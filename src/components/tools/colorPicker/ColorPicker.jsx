...
import { SWATCH_PRESET } from '../../../constants/ColorConstants'
import {
  Saturation,
  Hue,
  EditableInput,
...
export const ColorPicker = ({ hex, hsl, hsv, onChange, onSwatchHover }) => {
  const styles = {
    body: {
      borderRadius: '14px',
      width: '200px',
  ...
  const handleSwatchChange = (hex, e) => onChange({ hex, source: 'swatch' })
